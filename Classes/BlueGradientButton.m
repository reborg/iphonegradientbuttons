...
- (CGGradientRef)normalGradient
{
    if (normalGradient == NULL)
    {
        ...
        normalGradient = CGGradientCreateWithColors(space, (CFArrayRef)colors, locations);
...
- (CGGradientRef)highlightGradient
{
    if (highlightGradient == NULL)
    {
        ...
        highlightGradient = CGGradientCreateWithColors(space, (CFArrayRef)colors, locations);
        CGColorSpaceRelease(space);
    }
